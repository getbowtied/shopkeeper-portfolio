...
if ( ! function_exists( 'gbt_18_sk_render_frontend_portfolio' ) ) {
    function gbt_18_sk_render_frontend_portfolio( $attributes ) {
        ...
        $columns_class = (is_int(strpos($className, 'is-style-default'))) ? 'default-grid columns-' . $columns : $className;
        ...
        if( !empty($portfolio_items) ) {
            ...
            <div class="wp-block-gbt-portfolio gbt_18_sk_portfolio align<?php echo $align; ?>">
