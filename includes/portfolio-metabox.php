...
function shopkeeper_portfolio_save_page_options( $post_id ) {
	...
	if ( isset( $_POST['page_header_transparency'] ) ) {
		update_post_meta( $post_id, 'page_header_transparency', esc_attr( sanitize_text_field( wp_unslash( $_POST['page_header_transparency'] ) ) ) );
	}

	if ( isset( $_POST['portfolio_layout'] ) ) {
		update_post_meta( $post_id, 'portfolio_layout', esc_attr( sanitize_text_field( wp_unslash( $_POST['portfolio_layout'] ) ) ) );
	}

	if ( isset( $_POST['portfolio_color_meta_box'] ) ) {
		update_post_meta( $post_id, 'portfolio_color_meta_box', wp_kses( sanitize_text_field( wp_unslash( $_POST['portfolio_color_meta_box'] ) ), wp_kses_allowed_html( 'post' ) ) );
	}
}
